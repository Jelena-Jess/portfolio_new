...
@section('content')
  ...
  <main id="main" role="main" class="m-auto">
    ...
    <section id="bio" class="p-5 text-justify back-light">
      <div class="main bio py-5 d-flex flex-lg-row flex-md-column flex-sm-column flex-column justify-content-around">
        <div class="align-self-center">
          <img src="/images/who.png" alt="">
        </div>
        <div class="align-self-center">
          <h3>We are a diverse team with backgrounds in web design, web development, digital marketing, and more. We apply our digital knowledge to your business’s goals and budget to create a scope of work that will help you grow your business. Whether you’re looking to start a website from scratch or want to market your existing website (or both!), we can help.</h3>
    ...
    <section class="footer-upper">
      <div class="split left">
        <div class="px-3 align-self-center">
          <p class="text-center"><i class="pt-4 fas fa-palette fa-4x text-dark"></i></p>
          <h2 class="text-center text-dark py-4 border-bottom">Web Design & Development</h2>
          
          <h5 class="text-center font-italic pb-2 text-dark">One of a kind web design solutions. Each line of code is not just pure code, but art.</h5>
      ...
      <div class="split center">
        <div class="px-3 align-self-center">
          <p class="text-center"><i class="pt-4 fab fa-pied-piper fa-4x text-dark"></i></p>
           <h2 class="text-center text-dark py-4 border-bottom">Logo Design</h2>
          
           <h5 class="text-center font-italic pb-2 text-dark">We see logo as your personal stamp.</h5>
      ...
      <div class="split right">
        <div class="px-3 align-self-center">
          ...
          <h2 class="text-center text-dark py-4 border-bottom">Content Writing</h2>
        
          <h5 class="text-center font-italic pb-2 text-dark">A good story is the beginning of everything.</h5>
    ...
    <section id="" class="py-5 back-dark">
      <div class="main py-5">
        <div class="d-flex flex-column justify-content-center">
          ...
          <p class="text-light">Grow your business online is the driving force behind Atilus. We’ve been in business for 13 years and have worked on thousands of projects. We’re passionate, hard-working, and most of all, we love helping our clients do great things on the web.</p>
          <div class="text-center">
            <a href="" class="btn">Learn more</a>
          </div>
        </div>
      ...
      <div class="main py-5">
        <div class="d-flex flex-column justify-content-center">
          <div>
            ...
            <p class="text-dark">The digital world is changing fast, and your business should be ready to embrace what's next.
            Ready to work together on a great website that gets results?</p>
          </div>
          <div class="d-flex flex-xl-row flex-lg-row flex-md-row flex-sm-column flex-column justify-content-around">
            <div class="plan-box border m-3 p-3">
              <h2>Schedule a Call</h2>
              <p>We’re here to help you grow your business. Talk to us to see how we can help.</p>
            </div>
            <div class="plan-box border m-3 p-3">
              <h2>Plan it</h2>
              <p>We’ll outline your goals together and create a plan to help you get the most of your website</p>
            </div>
            <div class="plan-box border m-3 p-3">
              <h2>Grow online</h2>
              <p>We’ll execute on our strategy and continue to refine and evolve to get more ROI from your website.</p>
            </div>
          </div>
          <div class="text-center">
            <a href="" class="btn">Schedule a call today</a>
          </div>
        </div>
      </div>
    </section>
