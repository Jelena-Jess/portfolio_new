...
<main role="main" class="m-auto">
  ...
  <section class="col-12 py-5 text-justify back-light">
    <div class="main py-5">
      <h1 class="text-center text-dark pb-4">Content</h1>
  ...
  <section class="col-12 py-5 text-justify back-pink">
    <div class="main py-5">
      ...
      <div class="d-flex flex-column align-items-center">
        <p>
          Our in-house copywriters are also professional English and German translators and interpreters. Therefore, we can provide a full transalation of your website. Usage of professional translation software and resources ensures accurate and efficient translations.
        </p>
      </div>
    </div>
  </section>
